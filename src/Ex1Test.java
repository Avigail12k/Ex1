...
public class Ex1Test {
    ...
    void computeNumberTest() {
        ...
        assertEquals(v, 11);
        String s10 = "1011bA";
        v = Ex1.number2Int(s10); //1011bA
        s2 = Ex1.int2Number(v, 2); //
        int v2 = Ex1.number2Int(s2); //V=1011 V2=1 הם אמורים להיות שווים
        assertEquals(v, v2);
    ...
    @Test
    void int2NumberTest() {
        assertEquals("0", Ex1.int2Number(0, 2)); // The num 0
        assertEquals("1000000", Ex1.int2Number(1000000, 10)); // A big number
    ...
    void sameNumTest() {
        ...
        String n2 = "65bG";
        assertTrue(Ex1.equals(n1, n2)); //True
    ...
    @Test
    void indexTest() {
        assertEquals(9, Ex1.index('9'));  // 9
        assertEquals(11, Ex1.index('B'));  // B -> 11
        assertEquals(-1, Ex1.index('@'));  // @ is not a valid character
    }
    }
